    ...
    class Cube
    {
        ...
        public Cube(string caleFisier)
        {
            ...
            for (int i = 0; i < 36; i++)
            {
                ...
                Ver.Add(new Vector3(int.Parse(cb[0]), int.Parse(cb[1]), int.Parse(cb[2])));
            }
        ...
        public void Draw()
        {
            ...
            for (int i = 0; i < 36; i = i + 6) //incrementam cu 6 pentru a considera doua triunghiuri care formeaza o fata a cubului
            {
